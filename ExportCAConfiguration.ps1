...
# Export CA Configurations into xml string
$xmlstring = Export-CAConfigurations -Connection $connection

# Save the Configurations into a xml file
$saveFileDialog = New-Object System.Windows.Forms.SaveFileDialog
$saveFileDialog.Filter = "XML-File | *.xml";
if ($saveFileDialog.ShowDialog() -eq "OK")
{
   $xmlstring.Save($saveFileDialog.FileName);
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBR1QkNB1fgKoNp
# 3n+GkpxVaH0pgRE9MGy2AEUhyjscbqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCB/mX6WaQhkJKZohohL3XGRMPnZU/Z/+hBAJzEUdFgVMTANBgkqhkiG
# 9w0BAQEFAASCAQAckT43UrfKHovRU/l2zNOFP7xoQ0SuilSWMZTLAnHTdUFPOxgb
# vkGPqVLOyRKhI5FQtt5ckkdRM+7XqUpMCCV3ooFEwnuM3U5PewRdx/BEazHURJRH
# nW9d99rflcr3RSJAtEq0kfVXO7CT//fs/jQ2y/ALrsxt+IvTA9Kf8ss9zsDBdGrq
# 2vQKal8+34Ij/2uWxVNqDpk86bzzq/gNh7HFi7VgqhwKHMa09GdwVXxR1AskWKAS
# k72BGLk/lIHUjo6go4OhFLh8QxqzxGLsHYv1TMccHkQi9swH2V+kfCAAXOrUlwzL
# tUPHANezTLZkvRJFrKt527F4Na5ZTWZyG382oYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEILbBnCxR61P82wSQdeHULmmj427H/yrrx0j226su5D78AhAN6FBmRSppjxjB
# JKvN1T2hGA8yMDIzMTExMzE1MzQwM1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# AQkFMQ8XDTIzMTExMzE1MzQwM1owKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvAr
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIAAf9DuhH+MblfH0gcq1
# SkCEaAy8JmcuIVJgQ9ADrHwjMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAG4S
# wEJM0wfeVeOnnliJfufEYIB9uWnpnIc3pDg5dT4C4E4mN3FEnJgU2zm67R/hdLsT
# znlYZwx9qQiM39K8cttazVHXEOtLB0kiq+3rTRbM+VjVXoWPqKmzBPxNtdia3w5C
# jDPd57/hcKFr0yy1giERxQorLtPUaEnjmT6CoTVrq2GPIadlDOwIqPduoYxWigBM
# FsBNDtsdhg5qBexzTZ3jpE2sb0y9W3zwYby05I4pbPLW7CReq7V+z4CVQpFzC8Rz
# N9HdH3duqLq1VDTMWK+i748MOEQeXPT0BrdQsFO59z0Z07mDRlDzsHZwumc0w9DB
# uPksvvEVKmCvTqCik7WO8+iOUfzXDgxE9gRPS+pqtRV/YPeAiTkpOm7daNo68Ma+
# SHPIRcetAhPQqyku8tln58w2WZG9HQIABWsaghk7j+0r8MggVn5ynyjOUUU5Nopy
# pxmJQf8kEZ+jMOG+ul9woh4WMuRVHJqyHUC2ahBnzovjeTjbXUJDqt7R+tIvphJG
# lLKa940kEOfrS4xJJcXOLqLlYRKQDMjbhmuFKVqAF/I1tz5P4csaV3kNAw3O/jO0
# 7iD7ZDbR4BDCjGDBMMdwwIWDqK9CF7oTxaTa+JOH10bDdBfkPj0Ao5gMp58peXSN
# lkoDAht45hLtYAmMMw8aD5GnZxM0ecFqUNisqUug
