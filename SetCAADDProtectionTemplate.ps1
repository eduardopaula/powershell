...
# Get all Active Directory Database Protection templates
$allTemplates = Get-CAADDProtectionTemplates -Connection $connection
...
write-host "Here is a list of the following AD Datatbase Protection Template IDs" 
            ...
            $guid = Read-Host 'Specify the ID of the AD Database Protection Template to Modify'
             
#Filter with GUID
$modifyTemplate = $allTemplates | where { $_.ID -eq $guid }

$templateName = 'NewName2'
# Modify Active Directory Database Protection template
$template = Set-CAADDProtectionTemplate -Connection $connection -Template $modifyTemplate -TemplateName $templateName
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC81w2EjU3erOuh
# slUD5piFU/Wawv+loovxrWvC2L2j26CCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCB0S3a/67swtY23QtqLDNr0Fchv+UC3Uk3FG+/I/moPcDANBgkqhkiG
# 9w0BAQEFAASCAQCFSbNFnXNsaNBqAGkAWYx5WX4iF2aI5r75qLkZxC2UNJ+4fiYw
# fzK7da33B3B6OeT+JWgmKMxZZZwnignDXi32VZGOM9NpjSJqHH1C4kSflQMv9Oua
# 0C+Ttk64P99xe9CiHcbwOR9eXaRkJlEfum5f+uBQPOvWIA/wBsm0VkYgvcNL+2IK
# +zInAsW5BFgfKVMAh6M+nLYBstXku14cqJv78lfvNp218910HIfIKaPV0BN2GAC3
# f5YCrXv3qVRgfIRxdC8gpkQvD1uq2oNWCGY1cU2+zyUcDs7pWDtGXGmPMl7LBEjJ
# zmKVCe+3ihSvSLXoS3foKsbqsXhYJadLPW20oYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIEQM9XZoYU81YSs+VvW/7ZCfSgQK6OYfvWeNkIR6AyNiAhEAwH56+FTXswBN
# 2itvRPjnzxgPMjAyMzExMTMxNTM1NTFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCrQwZwLxvCWzEELHfH
# 3fsWJZWh25m0prpT57kuRC/cfzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCX
# Ho3B/KK2SJUsqlR8dRXz5inV4vzNNFOQ1SW0GpGUXm20JSzbmR4UeishpTOBpuDr
# nRgXo/d6zy6m1fWKFBehO0sO44fy6T/icmCr4TzIuszlBqXfrDidr4FWkRhc+HZ5
# bJ+90GoBSHgmZ5qnLhbOiCXTAX8f2QWQi4UcCAbwIvWRqeo8ycTSnfSS8vbMA8PL
# JkxNGijsbcC76tl3fIs+0dJ/kdp4ejfy2E5RS80Eugh6IR3syxUF7iitVqRUQns2
# ovo8gCijUAvijveDnP9WKbwlzKBJCdXXxh5Rgygd91dAgRa87aE5TrcIX4NhtmMt
# RUQ58Hm6aYErqOGKAe2ZJvbLrCJTTD2sFfkUlEz7yeSySE7bdiWsJWlyoT1QBAwh
# gJM6VASDVNgLoi9o7DSthHeZnaFiCJxvVvnliwJ/nxLcKZbxEWHNVxd3e4lzYB39
# VpUeA//PHBVLWshdNlJmRAOTYR3f0IxaNH1yrejdCZmTNriktuxHutgFDRV+px+k
# 6zvPFTJNMyxvscqYuuX5YBPUIS96NEo1Pd2vYq+qKg9bjhF8FqfxRouyOVsRaKyu
# QARq3LxSM42sEwPgoAicTayiWmMjr7dxh/zIJC2tnVy1sqs+HwyPL35rw6nu2B2q
# TdejwS11/8vSQsSUm4l7D0C4sTwBfkRlnLKgirCTXA==
