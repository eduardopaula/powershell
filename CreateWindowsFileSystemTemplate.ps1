...
$includePath = "*" # * indivate 'All Drives'
$includeMask = "*.doc","*.txt"
...
$excludeFilePaths = "fileName.tmp"
$excludeFolderPaths = "afolder", "bfolder"
...
# Create new WindowsFS template
$template = New-CAWindowsFSAuditTemplate -Connection $connection -TemplateName 'template-Name' -AuditObjects $auditObject -ExcludeProcess $excludeProcesses -DiscardTooltipEvents $true -DiscardBrowsingEvents $true -Disabled $false 

# Get all WindowsFS templates
$allTemplates = Get-CAWindowsFSAuditTemplates -Connection $connection

# List all WindowsFS templates
$allTemplates | Select-Object | Out-Default
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA1aXxl+A7+Fmlu
# /VP6sOqxNeJhK/YK3kgy9Yiol6L2PKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCAQnXx/GQW/Wd82G7uayGcxT4mRG664ohOnCFVfZfOC6zANBgkqhkiG
# 9w0BAQEFAASCAQCPYTDkdR6B8k20IFcLZNex8wM+YmNMrQjRghdRXMJDolzgqamv
# i+fvxqxDj0Ihoj81nOr6yUHvsX+8NxsZZZAH5qMn2Q44NfnUeVzrgtBrvN/jjlFc
# L3e4uPkpMOAB1Tvlb1KGf3YS0cw+bRpUCxg0shnZ+sjp9hKG6ke6X7D6gJ9yEdeo
# KhHyzqz9DRTcVr5hpzmRwg4coGIIbDl8HRm11Hipu95W5ApWkL/6rkW3DHD19a1K
# /NnLjRzjx69vBvIM6H5zC8AaIP8LnW/dfV3bU0dujP2tR1Fxas5EUoZ11gATooWc
# 9Y/iNZ9amo1XiWdm0XziACZuUsxLHg+0yPnOoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIKMbUfbsZpv04XIo4ZwuEQ3aYEuH6rAt+5qFZBgaPx9iAhEAzX/LiSPBxC6b
# SrFejrsUSRgPMjAyMzExMTMxNTM0MDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM0MDJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCVfDjE/fP5TwINBeDN
# 2KU1gU+dbUeCv0uYcxf2f724PTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCj
# AWmKTc6DmMg3t/bVahChHbz8DQ0s4sHMoXV437LXg5OFPD+oYj0WBlEZUt97v3va
# n5bKY2TrmAGkVeiED+qPQKYcjtEJ09dgJkOuh5O1RBt9XDDIXhhST7XklrTAvNYO
# 3IMmcHqWZksAvthk35ygz8GovU01L0vHc/auOACIv5s3p4j8g7YXBNBBGNezj4ul
# XuBKCqjVcd7SBKxAChZdzkc+b9+smUFbjR8QqmhgT+BPEQg9Gcw+TK0I5kCJBiVf
# b1VhbQZyhKJAB6j2iSsLpbmUop/icLFnbeos22kjcjDB9CWmZvcsYdhPNOiy2bN+
# SYVDiAQZGjgUJ8Qwk/BdutzKiUjeyo39zqt8B1ITjJPd3lFlobgzsoTPW404Qury
# M9O9eVtTl3ecqcFvKbbY1B5+P5jxbeBMwdLz2aXLsqpDTA2J4xBDGnAjg3Snh3fc
# qibkqLI69NaowEArCmF9RzvifdxwwPV+IMZvzEPQTHE/wSCmeTwAntYXSL3Gk3ql
# X6HKVE/BKLrq33EgnFMGo39arbdCJiI/fTZW2PZbAz/ouOEpRE7LyIvrVnFoN/dP
# n1tIeVmrY+4IGUNOcocBSUUOU+AFNnIjFFsIkIVkeeqANWWehXnltCMa1+Q3olki
# uJqLnuBT/AS04GSHhx0mbwlfqoAoEk5LPSHTNyOJ6w==
