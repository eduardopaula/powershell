...
# Get the configurations and agents in the Change Auditor installation
$configs = Get-CAConfigurations $connection
$agents = Get-CAAgents $connection

# Prompt user for configuration and agent
$configDisplayName = Read-Host -Prompt 'Enter the Display Name of the Configuration to assign to an Agent'
$agentFQDNEntered = Read-Host -Prompt 'Enter the FQDN of the Agent'
...
$specifiedAgent = $agents | Where-Object {$_.agentfqdn -eq $agentFQDNEntered}

if (!$specifiedAgent)
{
    Throw 'Specified agent not found. Exiting script.'
}     


#Assigning the Configuration to Agent
Set-CAAgentConfiguration $connection $specifiedAgent $specifiedConfig

#Refresh Agent List with changes
Update-CAAgentConfigurations $connection $agents
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA81hTsryuJnhzl
# xa0Ft5aBGFXxZwADi2ssqBcHA4bRmKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCD65fYcvnkpkRgbH0ysfXkyCsouuYiZNgMueRgDkpJvxzANBgkqhkiG
# 9w0BAQEFAASCAQAuizH5DedvPuNlcIuBvOO8HCEijR3ZFi+vEkuU1ZaeywU7oxyj
# PlQ+HWIFJ8Fc3PXVf4yIQtW1FUJZ2Sjs9ppyy4nM8Fi6Y2wyPXp1TR0ALPfRJwAc
# hoXruT6K+SQuQCyR82ijaZ49TnCGt5QNTbVuoLIo5t1kri3rqusN8Bz3LPD/35Ci
# nTC9lYTXr1//eMaegeYveSzmNqgpW3fdRy6ZECH/3W3jXdJib4xZXvHfBD2NFTfu
# TuE0XhN0SVZ2NwVKJwlK7a7n9IP2RnUgFpH7JCSBnvo5Tx1yd5j5c0b/cKIcHW5Q
# 40G0d4XEzXhUNDEmfcwyLMxGDTDE4wtfgi/MoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEICgbQty+YIAEZShleMzpky3R9q2TjZcxtlj5eEkBXULmAhEAn0bh+wBawsHf
# iETtt5b1YRgPMjAyMzExMTMxNTMzNTNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTMzNTNaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCAy1hglPkBXx25qDR7a
# C1aVpnkD/V8RwqCGH5qEv2sHlTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBS
# 68LTiCl61vzz5m4tansEbtL2ydBn/qtuZFICa8mAgoTWn4pLnBDsVuM9UxpEjFV2
# LZ5pUWaoQ5TA51NEagoYORaL760OeWUt0Tbxp3SYW3EtN+tEWatOyTTaPUJIC+yg
# cMT/0OUE10RjhFnRWe1Pzdkhr4/T7KexMzXvDwQUpKXxSgV7rbfZBkNgvUHKTr5s
# k/qmaKso7ez+y1pTKm1CoRR/lDwe4+JFb5bVrdvHV4b9z85z8WiIcf1kkzQU3dbF
# JjAu5R9+0V9KhQiy5y4M0dhdfui+KsykQ+H6b+SjsWwFXNCkoYp4PjhUexFAjm0z
# rXb8nYrO3S1hn60KQ954NQkvp/mvvOYpFAJWNwF22tAzuoYNedtQJaoiefjAOKzk
# HtV5oIKLGDcEtzaKajgyAClxkLD/WtMv3RQnghL6a2Vg4gtOVjfQaKYU53BcKLiw
# JEcZ8s+JxFITiqaj04zMN4c0UH2e9rBI3kbEOiVSKjgsspv512M6DeI+HCibgGWy
# goFRCTsg4A03p35UbUdk3KDNsfHtDMrcsbn5XzDrG+5L/V9HedhwU9zM1I1j5F3D
# R0ovFOGYedxjCK4tQ2lgQUNBgpI+DicO18UdeuaGD/B+NnQWX9wogMw6Ek8cZBtT
# oge7/VGpPVUS+ROWp07NctfzdeJ2wOImvXx1pA1+sg==
