...
do {
    ...
    "     1. Delete an existing ITSS Event Subscription`n" +
    "     2. Delete all disabled existing ITSS Event Subscriptions`n" + 
    "     3. Delete all existing ITSS Event Subscriptions`n")
...
switch ($input){
    '1' {
        # Remove a ITSS Event Subscription from the installation
        $subscriptionId = Read-Host 'Specify the ID of the ITSS Event Subscription to delete'
    ...
    '2' {
        ...
        if ($verifyIntent.ToLower() -eq "yes"){
            # Remove disabled ITSS Event Subscriptions from the installation
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpS9yRQGq4HIH4
# 3XGtINt2i0WVbMO2L0AEpFRdcqH+NaCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCAMXGMfnSGUb02GL/nerGIHqZCjeNsASKOSVVu9y3Ha7zANBgkqhkiG
# 9w0BAQEFAASCAQCyc6dWJ+IYnJAJos1f7DYGhff7wd4GOCC79wL8DYHTkJlKqi5j
# MhcPniUBxtRN4DrN3jN7Cl8x9u/Q6K2EnZ6zk/ud2LxzYVy6zVdepAYVi1N3LnWo
# VJ5B80P0qQ8VQYeEBVzmV3YZ2S7UzgdMNFTMNrLIGpL8JQF7f9lIWNQi30eQIAeM
# F82A6LDh1GeEiu7ue6ZAhy51WrIA4WLgk+5MweyQ9Zce26mis2/r3/EFKVdRsb0r
# Udk0fj+OjPO2cAmugF5EH3j4SC3/TNWyTRPN6KKzDNIgtOg2YE/ERLb09Im/vhMs
# MIXc5IWIsj49Wx9VrnY8XN3WjC9R0zXCh+7xoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIIOKa5Hru9qRxy1209Jzmr9xYbxd0A+Dw+p3m6eptO69AhA4hLIIyPwrk/xa
# P04qjNMCGA8yMDIzMTExMzE1MzU0NVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIM741gK+j1RZkMbqwr6f
# MNuyqx/9JwMFqwKPedQ+YNX3MDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAEGX
# S0aSs4usfkd7R/4OzuHKFSNBv4A/SYfqNYIWXa6adO6xfh6aKfrHkpXdscMD2Rcf
# 5oa2FkdrPON5pxjBOzKB2+nqmmg0dQngzliMLmzr/YFl8y4vW5ieAnImLNh2OAbb
# /ti59SRUFHfSEUX5/Y1wEaiNqNLXIA/71oXjdg1TWCp5xr6TyukLbAr85QiZx/y1
# y/2V01kfjZV73PJ0gnVQcGW+GzE9Z1DqvYjQ6NN92Jk42/+p/tSHKfhiAwuXuGlq
# uAWSueG3u4ar1L9IZdZRT++gVWF9YXkJEwyMzX6DxLqOOGk4EsAy9BgFwtnetVU5
# 8RsWXZsd2O+ZIXM67Jje6IfRLys1GNtjt/Qp7QybTLtrH1Xm3s1XgqgZIO1yMQyT
# wQSyMg7c38plRFhgflVvKxtM8zYhpxku/+3DIJ4z13t6THi00haTHt3T1lsyOiqK
# TJlglF7acFWZgHkQYbujapO5Y4faftEN95ebFtpAOnuNuRl/GiAWgUYgO1jlPvly
# AnfxaTchSliipacWwUkhKit6UTJ2rd1LW/aq2r2mj2jmBmXBS2G8pX67lrKs7GaS
# n135atZ4KEIFbMdqEZh3F+XWM7/YzRiKB0cJiDnWLPPBsmDGWMdFou/wz7ViUL+V
# XqzsIAV6HQd6PJ0iiwbEOAcCV5j6jQ7zOLQd+vYf
