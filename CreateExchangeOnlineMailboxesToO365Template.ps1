...
$o365ExchangeTemplates = Get-CAO365Templates -Connection $connection

# Prompt for a template name. This is the template where you will add mailboxes for auditing. 
...
$templateName = Read-Host -Prompt 'Specify the name of the Office 365 template'
    
# Search for specified template or exit script if not found.
$selectedTemplate = $o365ExchangeTemplates | Where-Object { $_.DisplayName -eq $templateName }
...
# Retrieve first five mailboxes from the Exchange Online organization.
$auditedMailboxes = Get-CAO365ExchangeMailboxes -Connection $connection -Tenant $templateName -First 5

# Add the five mailboxes to the specified template and enable the option to audit owner mailbox activity.
Add-CAO365ExchangeTemplateMailboxes -Connection $connection -Template $selectedTemplate -Mailboxes $auditedMailboxes -AuditOwnerEvents
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCVbc1QRuticsX4
# 5UfoBJJV/weBa9nbi9U/ShXByIuy2aCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCCKeAFW0slUl/LrC1b9ncrE6JmRggyuMYEEAoA/O7bVaDANBgkqhkiG
# 9w0BAQEFAASCAQADxCmmfn6z71z7p76uMGuGzKsKUWDBULk5MWf/mKmAqgSvYyJZ
# 2YMXi9EeMkPDeifkO3AaQD1dEPtMdCtTYtTy9YBW6CGB8qnW3D0gdI5gj6zoTQ8I
# wLyRymS9rlN6kZHWDGcgiitozN4eyO7MCT7DaVGeYzwNFDz+atWCTA0NwY7h3hSE
# k6TiiqyYRV4Te5x/3wyYNdulonxRvNnMHYCPTQ26yziEJ7gzQJRm5zBllBjOJjRd
# 9h95PcHq+hgHsi28XSqI32IR4MNSMl17jkmGgpSQqa6g4wWJWg8MSHwGIqLorA3y
# hfsFS0sPvarZaNZvJrRdil4Y83BGnojfvN2KoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEID0rxIWCKks4Jw5hT+8ThTnyeXSVLJBkRMiVO6Vgd3lBAhAasZsXtuZTXgMi
# XMtr7qCGGA8yMDIzMTExMzE1MzM1OVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEILMaT9y2C9V9CYuTxO7k
# RHz60mMdQHEsckssw/tbfAqFMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAIzv
# M2r1FjHuf0/wNuv04ChUKCBgxgRXvgv4+9lyigPZhFDaRpcfKsHZ9IfWdZu0Ggov
# i3pu9CbixvcAMD608KBWAc4pYD2TvUYDpfwQurgEQcVpVN27p78ekRLPz2KiwidR
# 5vDq3tNeH1k30FEY0UrmwFqBGTGPvLhJYTvf3Pn9Pxjw+vzRpyagBqzDy7XdeuoP
# khI2gPDd0dtnZ+Ue86m5dnlHkMsvC8FVx3ET+axcbSqAS8PNhVpEySk9MiUDoTFZ
# yQHkBpsDr30ZDOf8/TsAmVym+rsVwZz+N+7eu0EM7clx4KEbo3q+jgg+DJqGRS18
# BfBCvgF65GKs4Erdmgq5KiAjZlKrpvOeYlQ0UELktueInzHh5lDTj3a4CPudyw80
# gnFyMFaFWhtgEAVfsxQmzAq3NUodl/Nr/765N8W4jJjj//+ExcpO/m5AMEr033QF
# LY9Nh6Te/NvMO5pQQCci4F7q8rQJ8+uH6P7enfXpPhp9Dbr8IrLO8kyYPQXTvnZC
# ugOAjoa0n94s5s4LfzDtPt+wR94BLSvNzmjS9Wnji1EMqT/m+PHssnWmoWPru9lO
# KsoM9+42PcWdaXnsSEQti8nJ/3aW63ugcfMClN/seNiXL7rsRBzDH1xIePvyNk2W
# ZCsUDFbyksUtujPPVn+DFTbse+bxQidYNUGrrJZF
