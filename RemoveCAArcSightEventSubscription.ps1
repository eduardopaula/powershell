...
do {
    ...
    "     1. Delete an existing ArcSight Event Subscription`n" +
    "     2. Delete all disabled existing ArcSight Event Subscriptions`n" + 
    "     3. Delete all existing ArcSight Event Subscriptions`n")
...
switch ($input){
    '1' {
        # Remove a ArcSight Event Subscription from the installation
        $subscriptionId = Read-Host 'Specify the ID of the ArcSight Event Subscription to delete'
    ...
    '2' {
        ...
        if ($verifyIntent.ToLower() -eq "yes"){
            # Remove disabled ArcSight Event Subscriptions from the installation
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBzro9CdKTRqda1
# 4hx9XplcbQoJiG0aefl9LW+IGFrpP6CCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCA3S6GOZ062YJUhMi28qsrKJRLcNNaFdlN81m2lKfkIRTANBgkqhkiG
# 9w0BAQEFAASCAQA4vtHIg26vid1uYW/nvHwZS3CW5PY86exMJMx5USv6pxlP36hr
# PfcTW26KuMYcjyyYxD+dlQTOlI1XvG74+b7bRbIaQDHFirXEzSZq+mOlN+lX0zv4
# BzLKZozrqGPyXyqfVgW2RKCHpQ28ULJi5dSsR4IgptCA+OdBT4wqDOj3R8PiXvlP
# lhtwM03Et8FP74kQ7D/6XAbx0E13XJzScKtThxJZrrDHwodUbnXZWTUCIh+p6uqf
# a1bLr76Xw8JVamZHoTHxhtsamQRnKiApq/tGDQfmYtKzBCUD3n0+/rtHEI8fAD7g
# U8mWgji10epbHK5HTrOAWG/xFvJUsNGZfTKhoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIG2BQ/mKoyQgB7IHAcd8wY921v2AEWXEsGJp9w5JwB+nAhEAo0ktp1md0ZIu
# Qd8sPZHrCBgPMjAyMzExMTMxNTM1NDRaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDcw9QXwmHgbW32vSA6
# 2o4K22feGEYD8+z3hLBwmLLZLjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBw
# U2BPCYLi8FMwIAz7O41a4VgvWZKxJ9a3BTXbD5phmJlA1vc/OujH/6AAJCvI4tVJ
# 1bdZZtxzoztSfkZOdRJz8kLwrXzvySIbVIeWsFmn75NniBA9j6MYFMM10gLDGhrz
# ATveFP7E7rr6wsWHv4/Hpc0PFgbCXIkPpWqAENiWWOTxvi7wmty5UYoKsqCNmugp
# SkIicSSq1tZTuldN41qfP5GIRDV38sCS7LXsRmblZWRgzpNfVD0ANbio/wdUI8tA
# Tnej2uHE2BOJCCuj3UuLt0czbP1FpJNg92HaF7hqDynH8m2Vm/gz3Je56uUqyYCL
# 5Hu+7pBKjVn2m6IutxRNHOMQ0pcAQAYpIF0XjySOQNKyYADE7xKogs8tJVZKT6OL
# uNRhlaqtkV7BRix/4PpNzECw2uDlRaVntJC2X35nvq188McY4WgtWelI2W6rKKUU
# V4NssF6+J39SxlYrbCkqEgc0x5C95uHmZgis7by2bggcK1eV67D3emNA+SOexNyB
# zWG3LVvuExCc1yvrEfQRNAd+Osj4IMZabaVpFXCsxEgl/G2uyZ88dadygmnilDVQ
# N0dpjSLBGQmRCDTs8c/k7od1iyiQwOtwHWV+7xatZalRK4ym0pQOvrUTmxRG2wTJ
# 0rk7T3O4owp5Wb1RB43lOYfVX0RFTiJ1hKZoLdm47A==
