...
# Create a new ArcSight Event Subscription
$arcSightHostname = Read-Host 'Specify the hostname or IP address of a computer running an ArcSight Logger or Connector instance'
$arcSightPort = Read-Host 'Specify the port used by the ArcSight Logger instance TCP Receiver (or press enter for default port 515))'
if ($arcSightPort -eq ''){
    $arcSightPort = "515"
}
...
if ($allowedCoordinators.count -gt 0){
    New-CAArcSightEventSubscription `
        ...
        -ArcSightHost $arcSightHostname `
        -ArcSightPort $arcSightPort `
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCzBZrDHQVDg7Q4
# w6LTmaC9J2Sf+qTh+4QxSJjFG4T/caCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCCympAwgkC2Qgjl9cAcAF1uBd3LRhUZJUGdIqMkxCO38jANBgkqhkiG
# 9w0BAQEFAASCAQBOYXsMlUGd2UnBZxLPkazHxG9DVLAFCRFCqrh39QOjSnT5znBm
# Is9noChFPiSZ81jxQNyhvgEhyokmBn/XpdKyArAVfTpyRAfj/fTEUeYnWNmvBEjH
# h2ft0GFGpZcBBadiS4YWh0QNTsCDHRxzUk9UbCXfFCGo5gkvNJkiYYLlSA1fs2mb
# 7S15/hhajN3on8Ykgqda9XHH018JwFm8n3zM/ky9Q5Gv2ZbqfXmwDO89bCvutGqB
# 7PGsGt5/jehAV6yhCr/eJqhfZmmG8Ga+ZhFANvlra3wIxpFxVbPSAD6hyrEnDbT1
# SueDCUuwpJgTNq+fFDK0S9Zk+nYwRaFgYHNBoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIIiuTUEwhQV8HWhoUs1k3M4TzLSfBOAJEkxx/EnVRm/lAhBvgkZY3jJLoPL6
# mU8u7KD8GA8yMDIzMTExMzE1MzM1NVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# AQkFMQ8XDTIzMTExMzE1MzM1NVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvAr
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIH/zmtqoTd8ujlS1nyzR
# rRm5YQjtM2XSO8aUxsisZb3OMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAIh0
# pANUFOEfR2clLwMh1nB52wXPzf/VT1NTPFNQN4nh0cR0v7eQT3FYM7LHbw41i9hi
# 9M0Y2HbMLedWnsfoFmV83qIqFyZL6xX8hTSNTWkuVIUVJyMn16l8aqNd4PEwXhGR
# kt9wZEYmJuqwaeztjL6qCELr6SQ8dJi10nGJGpyxlUU7QhWDla6ND589tGgpLqSE
# bzKlIrjIbr6rA16ZwwxhEbyZJupGPGhRNSZ1lKw2iunTb3gEJQ/QhEMKfyT/4LAd
# ynXrZ/RjHldg3wPhmikkir5/hcKHUhAQsX5h4hQ05RuEvp7+t/BgUX6u6daDHeu1
# lIkMSSiTYoPe6hJNvl8biIqqy4Jp4a1zerbsHBy45weBeudYKEBF2J2V5aHi9cxV
# j/WTaLKd8LjWgfEBidmTIfKjNNIyL90kgKLNyO7kVXDy5njUkAYjeStL9b1h2Z3Q
# jwtl78c4bY8gabYCly6B7lbNfBmSGtFInHbNqDMerlZq0KsFL2hsneBt+I/5uUin
# RIYgqfdlV19SHGZedqiWE7sNvzW29vu2hIvMfhODyZexcbdj9olDTpFYegukGrQ4
# 1Luk3bk5cw5QM3aCa/Vk+9rCiyDtf5Bf04FGhv1TEijujLAGg80q3e76I5XTECMg
# 4cPWi/QbNtukQndfk3Tb4aNuvsq578McdTT3CwIw
