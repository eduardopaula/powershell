...
# Prompt for credentials required to connect to the coordinator
$coordinatorCredentials = Get-Credential -Message 'Enter Credentials required to connect to Change Auditor Coordinator'

# Connect to coordinator
$connection = Connect-CAClient -InstallationName $installationName -Credential $coordinatorCredentials

#Set the Agent Name
$agentName = 'LYNC'

$agentInfo = Get-CAAgents -Connection $connection | Where-Object { $_.Agent -eq $agentName}

#Prompt for credentials required to connect to the the CMS Instance
$dbCredentials = Get-Credential -Message 'Enter Credentials required to connect to Skype for Business Database'

#Set the list of items to be audited
$auditItems = Get-CASkypeEventClassInfo –Connection $connection

#Set the Template Name
$templateName = 'Skype for Business Template'

#Create the template
New-CASkypeTemplate -AgentInfo $agentInfo -AuditItems $auditItems -Connection $connection -DatabaseCMSCredential $dbCredentials -TemplateName $templateName -UseWindowsAuthentication $True -Disabled $False  

#Get the template created
Write-Host 'Reading the template created'
$templateToUpdate = Get-CASkypeTemplates -Connection $connection | Where-Object { $_.TemplateName -eq $templateName }
$templateToUpdate

#Update the Template Created
Write-Host 'Updating Skype for Business Template created.'
$updatedTemplateName = 'Updated Skype for Business Template'
Set-CASkypeTemplate -Connection $connection –Template $templateToUpdate -TemplateName $updatedTemplateName -AgentInfo $agentInfo -AuditItems $auditItems -DatabaseCMSCredential $dbCredentials  -UseWindowsAuthentication $True -Disabled $False   

#Remove the Template
Write-Host 'Removing Skype for Business Template Updated.'
Remove-CASkypeTemplate -Connection $connection -TemplateName $updatedTemplateName
Write-Host 'Successfully Removed Skype for Business Template.'

# SIG # Begin signature block
# MIImWwYJKoZIhvcNAQcCoIImTDCCJkgCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC2gOVfDy6QNGt2
# hTL9sdvxbfij88UHv3XTBK7RELGpZqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBkY0jdCp74pPZKVXvquEBVg6CPJKCw6BSV8sie/nBc8zANBgkqhkiG
# 9w0BAQEFAASCAQAGIFW9MoBIPS2d/ppWGQhkqU7fasVGNJYn55jSZSlVzkO2qTtF
# vBkrs+TWidc/uUFS3WSRaxzuE6G+/34wr5hdNk1SVVjo5XRzzThP5AFC22GWMQpV
# orwFY/hnngaOQNaL1/MyAiZrz5G8Cx9IHh3Iv8/q4Fy1MAEBDSFPlPdMMA6eQOWw
# l44pVblzIfCP/McAVM6VHGOS+aQ19zkwXta3owtGqeUr4pvtcXZQMh2RrSdIJMcf
# MT2NfrtCJ2O62mCKA6uIKGdBwIPCaMKHmlsvG9EFQtbXnsXoGVjT7FkwGUlbU46J
# yeD0WHQltrQUMiQ/Gzxe7bm3fL/XGOuF6t+IoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEII1y9AqxcsPtQ7OhtCBXVv2tqHSgItwjuo6I0yQGDlUFAhEAsT36qTGaFQGX
# W8v2uvnAvBgPMjAyMzExMTMxNTM1NTFaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM1NTFaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDPdkVKl72jjI5R9Hs1
# LFKgBkLPMLCi3kNX4l8ZtkCnaTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBN
# rIfa7+xK5ABAYz108HTno78M6AaieAVvELkAGf0E6i0C+nrVic+J75MjDmJRqGTA
# zFWjzCtgzLCmUPPp9Hogz5SiJw5X/SLY9uOreNRNmZXdBRxcS8uorkCzwvibpXne
# 9cvAIrjnapl5MQztWT42lq4bXFHMrf0Ck3TIS2sNKtX/j0odsXeMc2kJWTLaBpRW
# bZurHmyfh22sG7UKlStvpWbIa6XiK2TEpFPFbk2WoKOwXRu1EoNeRqzyvzYLHILj
# Qomp+gIfOU1XxYWuCMGUKcYELqHOvwVxgcDyZB2V0N7W8i6ZPVhIGpw3jS5Xuykm
# nMYiHzRmUg5jF4Rgb9dk2l+32zYQqDb0/bLqbSG7oKnYb7Tm+eTuRIjV05qgQgu2
# qmNWLq3kw/JCoql5NL3OwawcKuodGid6Zd6rdEC6BxHPnJq5lF8G1eRwPZh1Q7AD
# 4CK1gwNN487wqjGPmehiDTNLay5mVY9BaJq5gj2y5gWZtHtATcK/DjNNeFX8lGzl
# kxe61uD1sNVlrguz0HFCPFALgNA4R5m1P26Tr2syiw1UwLo/cqFSn6dMNSA9U49w
# /cWoD75noAT4k+gKYKWL815ytEtx2b/zxALj32XfR+cm6xSWmbI9JgjY2kTcRxPC
# n0kKxI1R581rbY/gisSUesqNq0hBSs6fwrqrYgNRfA==
