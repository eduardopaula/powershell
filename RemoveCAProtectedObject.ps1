...
$verifyIntent = Read-Host 'Type "YES" if protection template contains protected objects in a foreign forest or "NO" for local forest protected objects. Default is "NO".'
...
# Prompt for remove all protected object distinguished name
$removeAll = Read-Host 'Do you want to remove all protected objects? Type Yes/No'

if($removeAll.ToLower() -eq "yes"){
    Remove-CAProtectedObject -Connection $connection -Template $template -All
}else{
    # Prompt for protected object distinguished name
    $protectedObjectDn = Read-Host 'Specify object distinguished name to remove'

    if($isForeignForest){
        Remove-CAProtectedObject -Connection $connection -Template $template -ProtectedObject $protectedObjectDn -Credential $forestCredential
    } else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAK0TSwtitSzXs1
# PdtWFuSazH3PezL0fXyCcdLVrmRETqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBS8f6Gw4X2A7d19svXF6YGQJLWmX44eKAuqnhKOd/YOjANBgkqhkiG
# 9w0BAQEFAASCAQBVzFXHyIRzOThtqh67Iw5d5n1q/z+kLrT6ZDLsRIHD4GNR28UA
# bnrUc7rHNsd7JkVLM3LLxMHGaxOQ78r/ab3EWYxzSfWPaOVzAxfVEJgEsOItHqAR
# TLhxBj4lhd0VmNROeYSxins3gKgyryL+Vk4Ct7yhYUQCnxcRPPaMNxN5ePhN39VK
# Ou2/Cuho76b5mOJwtNYGkJKwGamjUN0pQFg8F5hF7Kt//b4hZb5yly6fdwakcGqi
# R5apk11zCwsi2P+h/ESzs0zBe1mgoFT0nyyXNKFcFeFz8PisT1lwFMc0EzgwJiA2
# 50getG4E3l3gXAsZ1ExtKj1vrsXIuNXRsQTnoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEICY1Kb9YxD7t7httfpXRmO7wQ536WJS0JUdxtH94y9iGAhEAwvJHLVrSybkw
# 3oA4WcqCxhgPMjAyMzExMTMxNTM1NDZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM1NDZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDJkStzLn7Dv0Ffn56C
# jKu28N77f0cXI84Vc9+LY151qzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgCK
# g5SAte+XbLbPEfV/0XWPBAawbhiBHG2r/FeNFTISWOmYesnI2yaR/WG5wuEQ4GzL
# Ae1ylZUyyt8Fp5P7TEpb6P6RfK2w8OXk+U2k8BjYHveUOMUO0AcB44Vcgh+ARkdA
# ncTX55JiOWIf1T/gBu0G63E+pMQGDIegJCH4/E/y73Os02zUCesX8lIoE8BPteon
# fIDUDu3fTErJODLmSWasFPjclyF7F0j6DwkoU7+PyqUVmIDm9JKIU14OE7bDuqVl
# KfiSHkfI6ZlUPy3rn1GTK6Efz4coWNA9S+pT2stiYohFL+W14w30L2nqCFxuwuXj
# q5/fe3a183Pn2GC56xk0IZY/5C9SOGPWkMZMLN5sFyPyLFcMtTOtvOL9uLozXoPR
# 1iibrFAHZ4L679EIbx7nWgFFEqSbzV2Z9ZkwC02JuM7UXaLGzJV45LQr8ytcA49m
# +K6ZyhEe8tHeINeiEB982vwnyACdfuelfClOnJGMEzaA4GMsJdwplEHNcDY4+Bee
# rLVH8oS48p5mLZFHwPbsb+Up1ySUX7SCcL79yqQFTHkvmQAwVCu2j2DRwG2U2/I/
# 6SK7p/j1ByC+H2nP8B/G5Z39V6f6d35uaSXv50WrA3kcTTBAm7uhz+R1e+ov6U/v
# RflmpZEJfH9ySYBUnJDqPzwtLKuSnJ2JHt+oZErDOA==
