...
$subscriptionId = Read-Host 'Specify the Subscription ID of an existing QRadar Event Subscription'
...
switch ($input) {
    '1' {
        # Modify the QRadar Host
        $newValue = Read-Host 'Specify a new QRadar Host'
	...
	'2' {
        # Modify the QRadar Port
        $newValue = Read-Host 'Specify a new QRadar Port'
        Set-CAQRadarEventSubscription `
            -Connection $connection `
            -SubscriptionId $subscriptionId `
            -QRadarPort $newValue
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDTMTTpWeEYUifB
# 0Q4Ygl9a0XBcDfU6VGD7riab2v5gdaCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCADb+33j4UUgpV0YLPm9Ex6YeqVfYMEyh89jQ6ebg0fmTANBgkqhkiG
# 9w0BAQEFAASCAQAoemQUwm5QdPkLrZO5wPiuIF8xVNgdrE4UnFU5FNIrbbvsq84B
# GJ8uP+DNLnaT3r1et4TgCHgy3RTwOnTptD5PqgYYpHiodlLOGF4kG5wnELnv9lii
# ROH7ssOSsZ0gPvyklMERp6w9rKHJAw9IVZYLBXOs5ZTD3PYQ207hmxtPQm/HOIQu
# TqBv3+agYq1Nim396dl9Ejrkru+2Z3D/As3ynCPJp5wjrn51yCfoL0XdEwvvfa+j
# 3p+K0ySbSvPnSbYTo4msuS8kzX7SZpn/tZIxceHIhit1B51NgsMBXIo8LeeilMCd
# kVLQ0S7Y+D/xcZSSdfbiO68Olj5il9Ph3hmeoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIOYjG1k101nOoCvhMYa61IxBD0P57AOhksuGfho8peZcAhABdVS6zRilst1U
# OaPpWpKBGA8yMDIzMTExMzE1MzUzOVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIBqnomBIkYAsJAMr5Kbp
# xYRJCrgLGf6VaE5NVdnDpJDmMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGgK
# LeCUTgzUhfIha1JrdlObt3QveUbQkJTm3bAKMZkn9dT0MUJIewale5966o+o8Lxp
# XnClIeVhHAin6LeDVesQoNhadozerHZexKxDlyx9qRBJ56SbPVRfv6PYSAI9sWTH
# ewBO1zYUcKeimQkWC79ntNxdmaJFwPAAHFV5fC2MjLWm7gP9bFh2kuS47AUuoVNI
# z4SQ0cJYPHKGFmKGzIGSR0Qge1p+UQz+Z71ME1Z11n9fkngMCjoYV920XeWxjUyl
# EoKSDSlykhzKmAEPD+Z3IvFRHPpGCpUxzPFtEF+JWTpyXtNhhIhCswTWDy4R5pBP
# a9FPmLyd/6CEvLr2YC06HfXr2GgkUhC4Y/qzU+FnuVutARYNSabGq63TbDrlAy1Z
# DE7olDXKt9OFIZ8NR8l8v22Epw2z+DY0bymEqIpkajDWHAFgAD/jhudZUikadh7n
# cjd5iuO+eC5p0iCSuUp7TH6vRN5Nij60NIPwvenS5HH42R9b25rsFEGWMLnIhlVS
# 1xqCdPRc0XKpQEgmSdmkXTkCqORa9te8wIoHXJyg0GWtkp7a6f2NiT6jwPDIgIWE
# +EnkCoLoy5SpPdZXrsev7IjOj6lqpyEwZbI6Ri/NPNgFKEBL475QEHVmlJ/WC8wb
# oX7ep2HNnbc+g6Ps6ucply7sBL/bLpyd6JUfc+Ux
