...
$searchName = Read-Host 'Specify the name of a search to move'
$newSearchPath = Read-Host 'Specify new path for the search to be moved to'
$userDomain = Read-Host 'Specify the domain of the user that owns this new path'
$userName = Read-Host 'Specify the user name of the user that owns this new path'
$objUser = New-Object System.Security.Principal.NTAccount($userDomain, $userName)
$strSID = $objUser.Translate([System.Security.Principal.SecurityIdentifier])
Get-CASearches $connection | ? {$_.Name -eq $searchName} | Move-CASearch $connection -UserSid $strSID.Value -Path $searchPath
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA8XJHXwSip6Kth
# 0iBBdkhprYwT4stYEOkhS+XdSKrAiKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBC2MDYj6CK4Jv8M10crQQGVMvV7b+rk8FII0Cw0H+SQzANBgkqhkiG
# 9w0BAQEFAASCAQBrfQGTeAZYVymBJObIlUoP//mM3ljiAB0J8DuvMOkBtA7EGfiU
# ouBusQ/4VyRjq77saOzSqiZwJM57iAk/BuYsh0fS3Qe0y3ePg6lwbcMs6FnT1WsJ
# Dg6uAmHsdju1X3/pYKZ/fa9Oxw1NshknFJNecJbe+0Xs+cFa6aTrHyotML41oPhA
# TKBqghIcwZ9FLplaonGZNkjl0BELYzt986dnT8PHh9uN3aWUi1clMs/AmhQF5lD1
# BcA0Fc7tdTkfGcZO6pLNgIX/2oAXhTiFI/V+OTrhEw8LyzL2TNY5wBpRpm7yxKq1
# NausYfObxOO/2sD6jDmaCB9jQt8/azDWftEyoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEICf2OIMX2Dq1STQLsATxfm901RQ4xn7xgqa/+tQ6CXyBAhEA00xkOxZ3xiWe
# epevjAPmfRgPMjAyMzExMTMxNTM1NDNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCBVFFbnHq90bHOvo2gA
# dMlFNs2inCZGn0YGIe0R6x/hfzA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBb
# x7iHsg9mZnb3gkUnyjTwCNXosBm22lnzGUjycs63g5wI8QFyijeNB+rDL7QZtimf
# bHugFu5wEsRNPGz7cdT2fL4Cnn3Deol1dLZ+32Onl+CfmuvGnp9sO1VrwN4NyUg2
# owzzI1lGJgUo6SR+gEWqtk4jdWbAk/x6a362fGpqk1hzrg5O8ZR2ScN3OOrlslAI
# 7Sy9XyGgDObhSk9VnJ21QH91cmcNkTxkAanNGkv7PN+qrbJvC8fL2CKa2ot8oAhg
# k16VAX9y43F3MGuRU7MLA5/bS8yj3+Rzs6xblN/bdMu+HrbWyCkLiqqNf1JCThlD
# lmzwbJeyg/Nh6rR+BnzQK5Hr4vG2YxhpcUW5YM4X5CNGDl63St990aVIAcUMXKJW
# wkiQNuhtR2sWyPh4H17bTA8UqoAvHhVKw1ESVxxN3fjc2gkFgk5tRyIYUb6TFPiy
# hcuKgx1I6jP7ciZS6Mp0aB5XShP4Om+puSjPn20+hBp2KcQYsxPwiWyvMDV9zaXR
# WIXTZSOXG0P+FrN9VDJ/8FDtaXT/Ksh/98U948Uk+Sh/5eCFwK6QSmaxf415pXQJ
# Co6LVI1DVp+wM5zsGki/dkjZRJ31Dmv+7UYpPW6WcuU09BfEMeRwKUnJn6JawO6d
# TjRHcgKc05Wa90CblKvw7GC5Y8oomeY0lni2QphaMg==
