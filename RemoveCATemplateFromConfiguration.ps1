...
# Get the configurations and templates in the Change Auditor installation
$configs = Get-CAConfigurations $connection
$templates = Get-CAConfigurationTemplates $connection

# Prompt user for templates to assign to configuration
$configDisplayName = Read-Host -Prompt 'Enter the Display Name of the Configuration to remove a Template from'
$templateDisplayName = Read-Host -Prompt 'Enter the Display Name of the Template that will be removed from the Configuration'
    
$specifiedConfig = $configs | Where-Object {$_.DisplayName -eq $configDisplayName}

if (!$specifiedConfig)
{
    Throw 'Specified configuration not found. Exiting script.'
}

$specifiedTemplate = $templates | Where-Object {$_.DisplayName -eq $templateDisplayName}
...
#Removing the Template(s) to the Configuration
Remove-CATemplateFromConfiguration $connection $specifiedConfig $specifiedTemplate
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCA6p7gJuyvmVtOO
# YvNEnAGUzzSAwu3XVTT2iLd6pxJH7aCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCAmSrEbRP9BFCBGlVZIxA+DYNZ2cowgbyr7n+ZFwcLjbTANBgkqhkiG
# 9w0BAQEFAASCAQA3ct4ug8dJMeJBbpG/Z0iIPLwIGw4mZNSUqSZpNsgv327vaKMN
# O1ndIUnxbdYmuZfjif8YyyHn/vCIBrXAQisHcox2DiNkn6ZXKbFOzdGdLqPYKREe
# vig06cwC7aQbCaCMQAv8LRcFEjlLQsKb+c+VR5BPPNyjTASHizwLQB3SrY/LbPHK
# NvUvsd6Mbq+6/98oBXJkFADWXuhTLtbdQneOc2w+kbczdl+FloYTl3jQH/htkXdK
# 5K8iCdrS3X1r4Do+xvCE/XlrNl/gzB+wG4UzlLn4EIz9OIpvYOfFLDocpFbuxGR9
# J8pzs5LIcda9jNsLpjwkQUAcLYludmQVcdl8oYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIN1q8syjJh7DOVP6/Yv25VX2qw1AqlTjJleDKuZ4nBtEAhEAnew3REQKSAQ4
# zJ+rcwEfVRgPMjAyMzExMTMxNTM1NDhaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM1NDhaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCFBcgVdr9+m0/N38+W
# q9hxz2B5wcrU122WFmgFqCfPsjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAx
# N5KWO6EDjCL1TC1KxPH+v9KBVr2OPi3UOx+6dpTJPYo1cGCtF3Si1M5KLT7Ef8+I
# 1wZp+dZt1+6ybVVQHRYyaXOi4Ci5GR/CG64fxvdVQH6VwnhLoOVwUTMOcRDtCTzT
# Ed7tuY1n/z16DAYiaqtr9uNa8fRX11a0/LrE/03vlENHukwqG5iEBrWna2isRT2P
# YQYmJW1ihY8p6qhSnhMkOuQ4hXuSeQNeKIsNsBCeG6/UlPNdkCQUUIo/PFB3lj8Z
# PgjdR2JGo1Dp2CnCxKyIYfZwzoDaM5tri3EftcCzc2CZwrj7OxhAnQb1GbkokifI
# wP0dyRVLH2mhYFyUlcpnBc54jgnEEiGN30n2YzFq25pRUDiIgTcH8Vg45yOSEv5G
# PDB2ObNYjVChBkUhh5ZNIKYJ3aG5dVZKj10jiCxad/lPPmTq1/67NX0csjbfmOAQ
# ZSXr7UCEa9eEVj2N8uSUNy0KQDVWw3k5cawmsS/H3KbLoSWfMnNx+kJS6H+5G+Dn
# 7jbpE9dkp78aLYI4EIr4Ahb/+HQTvTz1KbolZIQzzZQDkWTCRnZT8m8a3JdH4RXw
# UdrnPxf0omaIwiGaZxiJGmhZDZ+/D287aYFyqGpdNoM6qiebKYVLm4qPRFoZWXZ9
# g++R6/xD5Uz8BMDBZwlwJhfgsJviVxZ332Fkcs5uPw==
