...
do {
    ...
    "     1. Get all ArcSight Event Subscriptions in the installation`n" +
    "     2. Get all enabled ArcSight Event Subscriptions in the installation`n" +
    "     3. Get an ArcSight Event Subscription in the installation with a specified ID`n")
...
switch ($input){
    '1' {
        # Get all the ArcSight event subscriptions in the installation
        'All ArcSight Event Subscriptions:'
        Get-CAArcSightEventSubscriptions `
            -Connection $connection
    }
    '2' {
        # Get all ArcSight event subscriptions in the installation that are enabled
        'All Enabled ArcSight Event Subscriptions:'
        Get-CAArcSightEventSubscriptions `
            -Connection $connection `
            | ? { $_.Enabled -eq $true }
    }
    '3' {
        # Get an ArcSight event subscription in the installation with the specified ID
        $subscriptionId = Read-Host 'Specify the Subscription ID of an existing ArcSight Event Subscription'

        'ArcSight Event Subscription with ID ' + $subscriptionId + ":"
        Get-CAArcSightEventSubscriptions `
            -Connection $connection `
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAVpHtrsgssb8ur
# mQndEuOUWIJQDnyAu2+5q500dF775aCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCD2RUqlvhXtNU8EFkGVE87LFi+vpQ5NpBb2ZM9FIB73jzANBgkqhkiG
# 9w0BAQEFAASCAQCM8gVS6alscKd4OGZ7JR6pR0aSVzvjwBG9GeXbhUeeyA1Mwe+6
# A2j54cDZS4IOvcriWUCTN3gV+jnM9AtSTw88Vy6a93aapSEgEDBVTfIrxz1Den06
# ZNcFoQXXuxkrl7TCEjebLQVS/VMvXR4BdV+fvI4e/Zd7JGkjQMXLLrqag5wqKSHg
# 9Y7piesU/A1r9DQHtIc209zvkKHDWiNhpjmBcNnU0pUZE34XnFmLEv5tPIJScguX
# HJqi9Ga6mxuTMFS9HoD55GAZQUpgg/jyQqAEfBkfVeu7NL7CwLLCttCuZcTw5qp2
# 7gPxcSqnZENyAjiTIwU/j3Vm/xUFNRgZAHSuoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIGJKyvRKnXImIqttYI6OE+H1urlkKW3CrEl1P9n3usyTAhEAwrzhZt2NCusu
# eploocig8RgPMjAyMzExMTMxNTM0MDZaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM0MDZaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCA0DaCj1SCsUzZT78Qy
# hmT6nMcLSQyl9K29St6/8svfxTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB3
# 7ndnNuXgUlATbVKIdSa40VfXF9hiAgcJ1fk+3fmYp4x0vutzmcQwIog2VMz4+EbI
# BnsDhHU3vUApjaDOalyj0PHl+W1yjN8yow+6k7je7sqjeDPfTxeqm1xfq4HL3mvQ
# PyolCxIiMXUY/49glfV+R0T9G6nvvKOudmTuMlVaNask63MCfXbgMd4IqQwjMh89
# R1dtwYzsTORJLik7GIxPKD764473w3c1ECj4kR3xu1OxoTBCd4/kuUUdjOouP+sx
# i69PlhVnBhzCpRLZm2PcQ/5GH1hZY9XaCMIW5iQ1hIgJkrYLerHD6W6A1ywwU/Cp
# sHVVCO6bWQK9emMorPjk5owUrwpfJZytBO32jgv2DDciybO/KJVaTJ5jXMBSNWqU
# xdI0mBvMI7MB6EK2oJ31sM1y6/qtjU6aNM8xU+T9pfLm3QxbgRPDBfLzz4jHxakg
# UHID6g/7ZK9IbjR7ZvwQUdOCpkXrK2LeIXPHNR/rL0MZzL73ZZz+D39EboC27nHO
# PYn7OKlBsEI/54fHiL4IaFI1mD6TqxajwfuSWOJ95VmbEy3GtCsWLXI7JXiAOSB/
# ZwQt5G/18t86atPHo6rQf1r9R0KcBvL3Vd8+Xz1Sw7J+MIbq2sNXqSz1iEtnDJBr
# +aI94QORtfybNr2ojHT6KykONAlQYDjGG5mi4kWi8g==
