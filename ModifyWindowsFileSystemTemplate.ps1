...
# Define values used in template
$includePath = "[Program Files]"
$includeMask = "*" # * indicate all files.
# This value is SystemFile, SystemFolder or SystemShare. 
# It is a SystemShare when includePath is set to '[All Shares]'
$includePathType = "SystemFolder" 
$includeScope = "ScopeSubtree" # This value is ScopeObject, ScopeOneLevel or ScopeSubtree
$excludeFilePaths = "modify.tmp"
$excludeFolderPaths = "Modifyfolder1", "Modifyfolder2"
$excludeProcesses = "process1.exe", "process2.exe"

# Get all WindowsFS event classes for auditing configuration
$windowsFSEventClasses = Get-CAWindowsFSEventClassInfo -Connection $connection

# Define audited object for usage in WindowsFS auditing template
$auditObject = New-CAWindowsFSAuditObject -IncludePath $includePath -IncludePathType $includePathType -IncludeScope $includeScope -IncludeMask $includeMask -AuditEvents $windowsFSEventClasses -Disabled $false -ExcludeFilePaths $excludeFilePaths -ExcludeFolderPaths $excludeFolderPaths

# Get all WindowsFS templates
$allTemplates = Get-CAWindowsFSAuditTemplates -Connection $connection

# Template GUID. Change to your expected Guid.
$guid = 'aeac9fe2-bed8-4b86-a80d-4a7eec913a2e'
#Filter with GUID
$modifyTemplate = $allTemplates | where { $_.GroupID.InternalId -eq $guid }

$templateName = 'NewName'
# Modify WindowsFS template
$template = Set-CAWindowsFSAuditTemplate -Connection $connection -Template $modifyTemplate -TemplateName $templateName -AuditObjects $auditObject -ExcludeProcess $excludeProcesses -DiscardTooltipEvents $true -DiscardBrowsingEvents $true -Disabled $false 
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDpRt67AEHDPeF2
# khw5UFgRW2AsPdmJoyhqI8enY5BLbqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBw9KOgoGLKxPpjn2Aaw4i5wT/uCSfSwG1s639tgS4aSzANBgkqhkiG
# 9w0BAQEFAASCAQBHoURGOh66UIUlCDQebVoclq9xaQk7UF3dUEPWrGJzvFR0+Sds
# Z4Pxln2DYqhWetxEZzKIa/0SobJn28g816JcktMYU6rlaXvfOTTOwzhWJ4iFD4Dk
# GdVWNEWhQfRxiC/Y8Nh1Y5++R7h4Ve1+lMByVpk94yQgnVDEGoP+xe2Ke37KM1ga
# 5xwEmT2w88arw076k1LgKndazYGEbjcXR+EBkO4VVkRYo9XWsKhgCVNd7yx2Zu3G
# QkW0zMG3XhzX4DFdVG4E403ruawKJccc98FdM4+9fnPy8lFCuNZuHmwmaPdTug8O
# 0R1D7Ll7VN9yevO+h3XLA2YW3KejOm3cIMZ7oYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIHx7he15D21V1V+CNytta+cBlZsJbonOZLOmRPgqHz27AhEApw14llJ/nVGt
# fjwwJCIhPBgPMjAyMzExMTMxNTM1NDJaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# DQEJBTEPFw0yMzExMTMxNTM1NDJaMCsGCyqGSIb3DQEJEAIMMRwwGjAYMBYEFGbw
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCDvONF6egjfa9X0b8nG
# 1oI3ZnWZLMYofyYtPV+tlO+l5jA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgB1
# CPg7zKOnzGkZ79UYP8zr6NDX9/g4qN9vBLQwqZmog3P2gul2ikFBxwbBWkF6OeIm
# 0lcjqOaBYy7LzCI3PFKFMZofsqsCwVvGNNSsq/KgxM1A/4jSoKg+6bSIbqfyzk5f
# nsRJxr7qjlU0ZHcqnZKjEY4I2mZHfbWz9c2GvX+GVh8iEDZsMoD8XcPdSKhodspt
# VHTHrypECzFpQdc06+wPL6MDnfeHkSWPiHvVQBv4Gg5W8PG1oTLdTJs0hiIyHQRy
# e3aKTfBz3g/Mmur799uFm/UgY3TQk1qNm/izH2hviK2MK/4rfj3wYMpdS7fjB5v/
# 18wcXc0rL/26GaC1ZW54wsrVgJd2tHD7Mkfp/OunGApCTLLzPIto05uEULEuW5Su
# wntCP37VOUm7vdWwLBMzYUlO1uPnILFIj6VXxoD9Job5QAP0jA5w8BWAFryqntGC
# +Ts6kVPu+xech4py5lPQ0u7vgZ0DN77b0V7UCizuDJV3DDMXwt0PNPaUxbohkM5t
# tk1GLX/b3LxFlz7IopcAsaLZZFi3zE26W7g4JQNWT4Atu7zy0EhQ2zTh9Gbajm04
# owwJJrKmU45pqOlmqCQykEThK6eGwmP6YfyQpDFe09u4/vGXrL2+HTuSDQ+M9qrx
# edcVRJom+xdzeZ9ZTXo1pJQsmH0y+PUa5jcDwFSI0g==
