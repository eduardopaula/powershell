...
$subscriptions = Get-CAEventWebhookSubscriptions -Connection $connection | ForEach-Object -Process { New-Object PSObject -Property @{Id=$_.Id; NotificationUrl=$_.NotificationUrl; Webhook=$_ }}
...
$global:index = 0
$subscriptions | Format-Table -Property @{name="#";expression={$global:index;$global:index+=1}},Id,NotificationUrl -AutoSize

$toRemove = Read-Host 'Specify subscription # to remove, or ALL to remove all'

if ([string]::Compare($toRemove, "ALL", $true) -eq 0)
{
	$subscriptionsToRemove = $subscriptions
}
else
{
	if (($toRemove -lt 1) -or ($toRemove -gt $subscriptions.Length))
	{
		throw [System.ArgumentException] "$toRemove is not a valid subscription number."
	}

	$subscriptionsToRemove += $subscriptions[$toRemove - 1].Webhook
}

$subscriptionsToRemove | ForEach-Object {
	Remove-CAEventWebhookSubscription -Connection $connection -SubscriptionId $_.Id
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBpZIZOT02Mkh2C
# nxmkxEy1n4t2bNPNQyAGRffDmpsRAKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCA8TRY2gW86ZGprxxCB8ZIP1hoOh4U9BgT8G4ih8amsGDANBgkqhkiG
# 9w0BAQEFAASCAQBuFbyrlbET27ybALm9pHWXBGrIlasL62ae9wePDrKczFhUYmPW
# ICQwFvd0bSL+8968vgw/nd4AP9bxAHyunc/0FZQtPbmILN6jaWnZjASNhvDgHpKs
# ra9IJlLY+k6wjt/ztpEpnqxK3wEIfLCf7MXNhtxh2eshqzRtT8PskKgkZAcrUvZF
# OgdLKu9xhhPw02YsYgC9/qebrXDq9eSAjEQOhya7qLZDGMS+RpZJklVt3BmOQdjm
# 9bATF/Q5iAHlHL/sbiLcakHE8AGwlma2Q0x0BKgqPWuFOFYux7xNAe5DoS+K7kZP
# NjEER6ESmycR/v2158UDLjyrcnfaUIveyKLFoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIL2j5arRdz5LpcLbEzkMyq7MdGpxZbYXh+EY/hwAj2OwAhBfDxwGYRm0RdY0
# RpLxAytqGA8yMDIzMTExMzE1MzU0NVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# AQkFMQ8XDTIzMTExMzE1MzU0NVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvAr
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIFl7/1gAKY0hqrjicud5
# vdU7sKCuoOx71RjSgdQc0r3QMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAF2L
# 9AlfSgVZEtXGJrg6aEVYG3dTeVdSdN9VbtaXQdOpI6WJOaDNAwqfWM0wi/45OeR3
# PWo5U20XQqIve1Wfe69fv2q6KkFHk7Tw7vA2f+FWJYImX78uui+6QYwfrrCWZyST
# y3Qjkme9eInrvjjuLZYwqDFYM/fGgkazWlmWR5fCh+3uezsR+IaVo+TyJQxWhhIs
# 8VCqg0FYa6Y4UyI5PxGVPZ8oNI7vNllBpGbjit7fJXYO2IwGFRZEBoN4MJzPimtV
# 9Kl9JKvAKY0gcIN/HNVLhGkCnKvUXT+btKdxFlJwZUnsWEe9Xlf7gi7oxemI6s4L
# +7Mjt8lyS4fvMNJlLZ9MO6WZzfE5qjOhk+0QANkrvuRrBmxHzexqx2nfMSQK2Zjs
# wn0vm5vj2y6WgIRbn9fP8mHViZZNQodVDTe9Z/5cDmgxz1bL4jhqyOm4KbNhRIHB
# GHyFyqfm5JTWfyS3kRCFOsSg7Wb/U52NyDN90MwyLjC1130eHU24+boQS/PzWBEw
# vxvLrnI3Xq1IbkeHElOK8y4tb8uzusUrnn4XfAcImj/37YW1/CDo8vDs3PeLOMuh
# dzX5VFLnCw/SH/m4p6SPn8/gr3MPkBJCJPFgL8v+nQyS/ulugimTba2ubM3Nutz9
# aoo45EQMrAhkKpPaklJIiUfGCTj6iqnaq6dQXCgn
