...
# Find SQL Extended events template by name
$templateName = Read-Host "Specify name of a template to find"
$template = Get-CASQLExtendedEventsTemplates -Connection $connection | ? {$_.Name -eq $templateName}
...
else
{
    ...
    $removeTemplate = Read-Host "Do you want to remove the template? Y for Yes"

    if ("Y" -eq $removeTemplate)
    {
        # Remove the template
        Remove-CASQLExtendedEventsTemplate -Connection $connection -Template $template
        Write-Host "Template removed successfully"
    }
    else
    {
        Write-Host "Template was not removed"
    }
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCD0Ec5MLrh1SsFA
# gIdjiJyM5kLRQCnowwa5qXQaQu76iKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCB4S/KTVhYVwdS8zVTHcgZA79KyVNa578Qt+Kz9Sq7g8zANBgkqhkiG
# 9w0BAQEFAASCAQCSKZiNXpQiRZ9VDff2nYHR5XLHZzP+Yi4fYOHeSlBBgRdP+YkG
# 02c76DF8dNYRlRccmixal6VPbO6aXXxkgsv2/TjD7oN1mUHh6T5GiRCyngSNiZby
# WQ0VrVzgGmkjF0YvKGI217wNBZ5ICT5zAVjjakogV+kXi+GPvexaCPOAoqLao8AS
# I9a0bWLZBrGY2q2gRUzcF37GyNhzrGeWRf4EWxuTjliOXLo0e79TuaFO0MaVK9Q8
# A97ot0QZIVg5EUAPHhOAD1IVcMVqKmLXBDoYJ3vTFWCytlq+qa8vnaxYg+9ibr4H
# 4OaOf66xaKJU9hq+/cAU2rAlqI4zaxqzi3k3oYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIHZIkMaZZV69l6z1J9p/QwHGRduPX9v1N5eU6GZaZSquAhBRRspV32O4K4wa
# RafScLUqGA8yMDIzMTExMzE1MzU0N1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJdy+GVneJPPDuur8q60
# 33A019WQqV5Z2qJTm2w8M5QGMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAB1i
# S5UolGs+sxRfhsosCYzJbw9cjQVcre0wanq/jCLiIQtZOuClEOQwSEg5dpEo5U/N
# JxpCX2CYss6yi9cEjxFAvSAOgbM2iYKoXuas0GaVtuOHOrRCHOMJxt//OBa0L/ck
# CLOOb6iIoymeN0JtTAguyQVjcjL37Hpa3lskK+G6K/jzObS/TK+z3y2m7wXDZ/4x
# CP13jPsDlgn6C0e/mt5SsVyVWOH2gy8bZNnHt/sTK89PmJX1Tr6jQQaG5xehcCCF
# lk31lajkkbfZC1BrDA8HvLEC9UCYlAxWdGF9/ZEv4udmj+2AXMupZ/1y/pcBBAK6
# H14gEn5FJvXmZfDUr25RwtC+LnyzX8Sh2c4BACudG0inCKfOtqqDuorng1gkVWIL
# d6dXubBU1/0K93SIIAaC9TJjYj3mjiZ3gb5X7YdkkmD7dobtaeyTJijXyvcw/kSE
# iBPxF56/zVH+g57tyDm4MSt/sHaK9tWMnmBZZHjnnresP5QV4XcYfmqh+2OxW84b
# umBu3uxOrSOWMhv/654w6dXL2treNi2YvA/FzZdidW5dReShs/718rdWwslNO/U/
# ugTz/t62Nd+jUL1kK6vJ+NbXGG03O7iD9RgGYGmeAYFQU4eoVlIuUIe0qFsAoLxZ
# 1BHXnkEfDXEQuRAE3MpcbOwO1oXdgNIZiYrkF0A3
