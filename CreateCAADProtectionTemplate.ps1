...
$templateName = Read-Host 'Specify the template name'
...
# Prompt for override account distinguished name
$overrideAccountDn = Read-Host 'Specify override account distinguished name'

# Prompt for admin account distinguished name
$adminAccountDn = Read-Host 'Specify admin account distinguished name'

# If required, schedule the protection template using New-CAScheduledTimeRange
# Specify -Schedule parameter in the New-CAProtectedObject cmdlet
$schedule = New-CAScheduledTimeRange -Day Wednesday -StartTime 3 -EndTime 7
$schedule2 = New-CAScheduledTimeRange -Day Tuesday -StartTime 2 -EndTime 9
...
if($isForeignForest) {
    New-CAADProtectionTemplate -Connection $connection -Name $templateName -ProtectedObjects $protectedObject -OverrideAccounts $overrideAccountDn -AdminAccounts $adminAccountDn -Schedule $schedule, $schedule2 -Credential $forestCredential -Disabled $False
} else {
    New-CAADProtectionTemplate -Connection $connection -Name $templateName -ProtectedObjects $protectedObject -OverrideAccounts $overrideAccountDn -AdminAccounts $adminAccountDn -Schedule $schedule, $schedule2 -Disabled $False
}
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAySOcA7HkmBTEJ
# CfQH3QvAd+yl3adyEDmWujVd4FFj5aCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCDX6BuffqFRbwuZ8ogTnTpRg580QZnT5iNw0Q0T2d84EjANBgkqhkiG
# 9w0BAQEFAASCAQBL9p0ieri4hdruIy3TJ+yUr+49f8o90RVK4yGZHS5mKLB+3ZKu
# fZXHRe95U09pNGXlZha6/hhBKcs/THWs0mIo4OnQpztFMn2pTE5bFQeJDrD6kpQ1
# XIRYc+TpGkpr5yVZMg+TVKYNwyjnX/dAoZj8zeXzJPTp6FpoGJr5YiXjPdEhOwpF
# 7qjzkwsnoNagb9XcvPw+A/J/4NRX6bknRS75q24IqCBM8VwAjUeo8xqCJ6ddoJik
# ITfMOBEu+3I3B8rbBZ00Dlkz9iZiFnYX8dapaNIz4yjnVR6ifW95IjRqfdVfZLV6
# bD70Djjv9dbOv3CZ76sTV5RZQiuJMi+bhdrqoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIKgimk2UCdNG2ZGS8CN2ZGL27KfqwYEdSZcXW+kkWagCAhBh1+W+cLW46hVn
# WpuERquMGA8yMDIzMTExMzE1MzM1NVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEICD2smpvpld23bj7yDkC
# wmR8sT/69fMKZMYC2xOk87USMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAA7z
# wDkc9rfpNG96iUYh1zEkLYn+w1cbjRFE//bjuc6VzA0hW7dIB3vqWEUKFE4LVWhb
# sS12s3B4ZZMAp0Xqeu13HT8LB/dnntkwYY7qJBPIoxY2VvahqlGG07LeeqmiplCW
# ChXk8+rxK66pxh8Et0Fqj8aixxgANnX7GKf/r73Yk65dhdjf+XG6EIRWsEnfPFKR
# Lk0OCa9qKql9LrWk0cH/A+8h0xfpMeIkD/xo3ySssMjwGs5cKxE2DJxJh3OZck0q
# jlN2QqWv5gJXWjr2o7LKNKLHZ1bfOB9k871JSusp9TdUK1vXsEvZn6bjqD/m2kXP
# IstSum7KOmvLw+wQXpvSakaqm6SZ+Gc7hVZlDEw1rBy1X7AbI/PD/YpRVJls7NVi
# k/aMWcTu7sJMhBhbgxo3CXgV8ewsVK1ES/MNmg7tYJmOWASjGbx+m85Tzk9kJGhj
# Zoy6RlyPng/UWIwv0ghG3eGFBJ8Ab5aYxnSYHLvsFx8Pum7Crtz0CQmXwOrvuLzm
# OQNpN95J8QvNEf5uo5IdIUnIIdBsdtXNBuGJmP5OGliaDTJHprB736dEFF01v+s+
# 7ijniTueYDsSl6pCyb6HKyYYDql3GNh7AoSj9X8UuFcZVpTcY6wAfTXjZxPn6iPm
# J5p7KfYdMs9CwuiPdxvVbxwmleotNr8a3nHUVn3Z
