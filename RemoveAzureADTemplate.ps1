...
# Prompt user for template name to delete
...
$templateName = Read-Host -Prompt 'Enter the name of the Azure AD template you want to delete'
  
# Search for specified template to delete or exit script if not found
...
Remove-CAAgentTemplate   -Connection $connection  -Template $selectedTemplate
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBPwp5/rg4DmuAN
# hhiWRPXK+09Z1eeaynD6iAICzgwCF6CCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCCkNr++2V7ro1HjnRU203YGafieciJGYunaSZkUEFntUzANBgkqhkiG
# 9w0BAQEFAASCAQCdffhoKBjmIotwHtUsj9av7z9rpsjDo1XWJ1s5EyCdD+kKcZNC
# BZehhoZchE/zfk2pOJAjHUHg/6W1+gqqerfVJbhF1nYkX4qWCKfbQ9iVH1KQjAXG
# +TDIC/lKqLGyMh9QDKHb8C7PF3MV+XTDO45nsbQqy5owJ/BADxG6Mq2R3jitulFD
# eifUvhw+ZhONZO8fVtOMSaBOdyl+OetJQJvtX16/7UxwFTNuoLMv4RBaXGFrE71Y
# iFPsNHuylLj/leggKh1EsJgVAG3OsUdSCMvVgmVY5dG8btZdwK6KxPf7Fk5G+4qW
# 3ATxw+uEltIMEQHWfWIEoEnEF8QK2gFiwKt+oYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEIG/qvAlk1uoMhPa4CmkPohRrwoXK+lhUn20raz5abV8eAhEAxn0NMjwPaGxW
# wnMwytk7QxgPMjAyMzExMTMxNTM1NDNaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCCRJXSvhsuGP7MQXEXh
# jYUU6y83yFg7RCzEPAAYLw2gyTA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgAz
# RerW1Fjr1aLbH+8K36sE3KBk8QpAQiLJh8rIurKmqRsLfH6h9k/uUzW2qltDjdfc
# fl1SDfHO8lvev93bHMG3I6WejSZ5LibQVHoRIVwWcYEwA/UlLRWOnC1V0nVDzh6P
# cpUjLMFl9gj93ew06xnA+FnFL43r5fZLVZV36wMtYyY7Je3pK05j76trUi1pnQKD
# 0eNftjrdqyydoApUyf/loQftO/bZESzmEKXYGAgfp1YXy+/q/0n9cEaqPQoVUhJS
# 8Jd60zByPzXy2za2up2ddq3Q5gcBZfxT8/7789PNlKN2PrAj00REuxbe0YsabsQC
# qmf7HN5PxEQBZaUeujYNRe6vCJO051dY8J+KrV7j6AewToV4PZpQbnSYO/PPUny1
# imRtrpj77qRVY5+xGbjImJd0MbSEZKl8NuLMYyNMINDo88v7+XM3CbHIOhKT1njJ
# QsaIk5XHuODjnBUYiLLpgwKLW8xvesKdooZ834tyN3uCkCcN73oNDF5/xWHxAQVg
# Ba23IGSyR5PG2XBUzl1ad5wju6qijLVJWTeJRWT6SxkqvgUyv+B/z3W5HkVoAo25
# /uL3KcodOfncEMKN5TwUZKnWfeXBO5I+CSGINfOLdmB6CT3nOaYT2ZrhED32QOqb
# gkLDUHc+RGOJFRTvrL2lFO40F8dWIsflXpItPfKcOg==
