...
do {
    ...
    "     1. Delete an existing Syslog Event Subscription`n" +
    "     2. Delete all disabled existing Syslog Event Subscriptions`n" + 
    "     3. Delete all existing Syslog Event Subscriptions`n")
...
switch ($input){
    '1' {
        # Remove a Syslog Event Subscription from the installation
        $subscriptionId = Read-Host 'Specify the ID of the Syslog Event Subscription to delete'
    ...
    '2' {
        ...
        if ($verifyIntent.ToLower() -eq "yes"){
            # Remove disabled Syslog Event Subscriptions from the installation
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB/rGWyK7k97fW4
# JjHfPxoOwjG5cYTmnxNH0SE9a6rQtqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBiUE3qniDY5KpShPONfOn4NqQmorJ38fFFYXGl0CaTqDANBgkqhkiG
# 9w0BAQEFAASCAQBwSuGXD9+0xsaC5TnKFwMP/inHZmsL0302xzymdOwAIHIKyAd/
# XfJrWpjk06iRmgpPUPMYmRcQ8xhmNhVsj9VPwgdxgY8ZhQ9GtYq10iN6RXuIrEy7
# g+mjcMlTNmLfYIDc/+vkLHM5yO6/qhfBDQuXX7q6Z0YCDhNB7tr8VujUZk5zaPN6
# 7raW+ExJgsSV84/DhiDzcC+Xk4DEaFV2AGpt/GY03MrnRTS2fVCdYJyLgvzxQxB6
# yTP+rPuusA96xTQHS1cCA0/UDA1zF9q2LBRrumYYknVhQIeTk5IA3IvHIF0GYSQm
# HYt0QQb3ZJhklWtK+AOnUiSAtiCqWzyywfU1oYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIPxYf2JJU9Gnq3taOiIYx237rmlhkJx/anEZ59qYS+XfAhBjb8sIs03cYxlL
# YoTrtfIFGA8yMDIzMTExMzE1MzU0N1qgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIJFcAptyFc6DZHJj9+kp
# ukCAO2MeKcmIiR6rt+0eoqfXMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICADbz
# sU9WpwJuS1woKFFG3Cxyan9xlr+0yqu/sZ06gCdHwI9yoRgVRg1ugzDLK9LSWvDQ
# u/gD2leS74eX9w1cIIgLUg73EWy9C1lSI7NJXdI7OWYy3xbAYZFj4MRRcHnttOC1
# C8VIVI3lGS3bk4K1u29FTQT9RNTPQGX1BPBSavo7sMbNJyfKUaJXQ1psqu6U6ZpJ
# FyubWYwpYA/aN2irCO4ckT/iL2vlzBD4gcgMybh8TGEun4hSyQ7b1XneStEUannd
# rL6NBIoguZMKb2j64Nl7nirtgAtC2QiXIcBV91cInbDVm9QnchdAFTqLDbeOxRdb
# tH5FgXM2RVd6/RvhLtSjuP4RZtT48xsglK+wxA6mNBPqPpzeZcvVE3izlSJq+lv7
# ROBlWS5NGB4qaCQjp32YTo9lRW3kArb+zTKMxagDyvO1RbH6hXZ3I6isUEVNb5H7
# /LIVevBk+cTypKVbTXw91kN2JGR7IjHAa9su4lcuEEuXSqzhtydv7AATD3HkyxrM
# alVuEYVy/h11bsdxDvaM7JiS97lGYHzboxkkD4jRLFOkrxZvQMTohY2+qMieRtYy
# mg0NN0QJ+l5m4blUm82qoQjUuKwhm/paolqSIdMNvHnD18bTJn8x5Zi7IteJY9Ti
# eHz6XrmMvJZarW2JdqcOws0PGFFny0zt5u16g2oX
