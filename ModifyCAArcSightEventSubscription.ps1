...
$subscriptionId = Read-Host 'Specify the Subscription ID of an existing ArcSight Event Subscription'
...
switch ($input) {
    '1' {
        # Modify the ArcSight Host
        $newValue = Read-Host 'Specify a new ArcSight Host'
        Set-CAArcSightEventSubscription `
            -Connection $connection `
            -SubscriptionId $subscriptionId `
            -ArcSightHost $newValue
    }
    '2' {
        # Modify the ArcSight Port
        $newValue = Read-Host 'Specify a new ArcSight Port'
        Set-CAArcSightEventSubscription `
            -Connection $connection `
            -SubscriptionId $subscriptionId `
            -ArcSightPort $newValue
    }
    '3' {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDr3ZaIfpiamRzl
# 50J4/oiNTf5593WuCFoIWljf4hyyd6CCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBWB7m4c5ZaUD5Bgbvasm1wqAJBYyKce37DeZj+fYEVRDANBgkqhkiG
# 9w0BAQEFAASCAQA2JN019dIVgZimQ+86h40x7A7YqYLJ+Z3Jd23vJd2sVE9l8e30
# qCf8qp0cxGPHataW/dvIZp3U405LbqZ6WebfeE/BdLTaba7X5AO7He03J8EGFuxC
# xgGqIXMMqf5WdFBYMFs4CtTxc8yZuhonbOdHTBcpu9rhN/vuBTNGrRDe1RBpDKiu
# 0ALQmGLbLA8shXWR00SRFvFCzy4RVKo62TaCiqUvEf+L2RJr0oKX6aygm4Sogoxh
# TTNqxQp6T5BHEF/GZFhcDA5fQpSsIe6JWgzzpHFaA1qvvuwrw8My7nDNxscBZciY
# FmRwXTEfm+MhFDrxFiMS65JiMcjE1F6y8bHKoYIXQDCCFzwGCisGAQQBgjcDAwEx
...
# BQAEINEWGIX/tvmttxRvjssQzZxz7QEvyX9HOHEaVwrIUisAAhEAl74lAk8GzZvI
# YHbkhT8VixgPMjAyMzExMTMxNTM1MzhaoIITCTCCBsIwggSqoAMCAQICEAVEr/OU
...
# KzLCwskPgl3OqorJxk8ZnM9AMC8GCSqGSIb3DQEJBDEiBCC3fyfBR5XY4aYg9a5i
# xWPCUpHOjmvKTFnEjMN4ZM64fjA3BgsqhkiG9w0BCRACLzEoMCYwJDAiBCDS9uRt
# 7XQizNHUQFdoQTZvgoraVZquMxavTRqa1Ax4KDANBgkqhkiG9w0BAQEFAASCAgBO
# GBvaJd1xFqiqiKeqiOpilANwq+4Lr2rVZorQjkX39QmZJ8h58nNzPNeED/SxpMhw
# /716ISkMjqU4Av4n1U/RwtwQFhSC5B16RG5vnWNmewMK6dMFaBSqe1lZAN/t1xPZ
# Jbj2jJBscKkriUXlreQwyGXrHq21igUNIQ8Gh1r3FmvMpIAWpxcJKshA53HmmyfT
# aeutTeTDj2vgpApa8YDL3xiOFZsh83kWv31sQ7qsxJd7kgHeBaXy6uP8RkJ43yC7
# ui0nkLkqW//AWCEx8Z3MZT8gPr8OsiLVwYap8j1BJcp5SBfr9Fl1RDPqIj2WhbXF
# PVttVw6rtbxYEsskh3kcdCCN0POx0sFgMxiX8gEymNluVodxcvMI7NuPGkCL+32V
# NpsoSE2sw+W5B5RBnHQ9y+wN7aFBhvTTZHz0O20/zIEws9aHyCjQ/mHdF7mDuCJ5
# n2K25B0NU6DVZbiv5g7n5fRYnFQFgsNhC/r6G0zW0Biy0r+idhopIdBlmY7QGZ8H
# s85Dht1YHeKBYxIlgo4LDP/VBr+jDz1iqi7GYRlVUarCyHgqqC9tUDUVcg4NrjjR
# 5TY91LlnhYZhftA0CE2jTCeqIh2PIjX/j4nqWdjTM+LwLr1gKx3xLJp6zWr89mu+
# 2qDNhsz7p5vXj1N38jIMQIgT88iaHPUsPetJrKS8dA==
