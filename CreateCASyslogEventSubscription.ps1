...
# Create a new Syslog Event Subscription
$syslogHostname = Read-Host 'Specify the hostname or IP address of a computer running a Syslog Logger or Connector instance'
$syslogPort = Read-Host 'Specify the port used by the Syslog endpoint'

# Get the Syslog message format
Clear-Host
$validInputs = @('1', '2')
do {
    $input = Read-Host ("Specify the Syslog message format`n" +
    "     1. LEEF`n" +
    "     2. CEF`n")
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCC5irv7buNiDmBy
# 3RB34GrYeZW+nXRiK822Xch1+r/lPqCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCBwDsqWpoOCqTKUzzJBU3nOVqqCTcRwbC/zQW0gZ1Ex9TANBgkqhkiG
# 9w0BAQEFAASCAQBhYfHWk3o8LhyGRnXMM1ttSaOnxu4NMEMwo+NmfKUx7nKPrRTU
# VXmWclLLXxbEh1V2Sw/CPAddReoCU/gXG1WQyiQEeeAb9Z0EpdXCMzHrLtHx051a
# U2CLNvs6wS6RxvUvyGsI1Z3UHqwvXUNVUvCm5uuYUBkycZJguVjf7l2ljeAmvGyr
# O6iWCvwyb7mnJx78YGlQKL1KX5KEn2+29Jpm9uZkBj83MtKon2SpWejYXYTjgjUW
# 0AKDOQKsVv9DlQz/oYnAV/0lY6I1JHM46GV4vtYeR151G6RybiO61drQ+IAIfGfB
# P3D82Lp2CegHJZlu8zo27Ty/NSSO6sy7xIiyoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIGBsAwhb/HZE3khWuSkSqpSr7utJKphmkTQHM9/EQeQ2AhAmJZbEvwzLlpt8
# Md5naqZEGA8yMDIzMTExMzE1MzM1OVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# AQkFMQ8XDTIzMTExMzE1MzM1OVowKwYLKoZIhvcNAQkQAgwxHDAaMBgwFgQUZvAr
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIIpQib6h5LLtGB2KVexG
# zIgtTvTbOdETS1itJj5n7wcIMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAGIh
# TxyQqjbD/ZsHzC7WIBwC3faQ3SSTrJGg5flnvChgr0hLNtHs+JUyC3+r8fpaIFal
# Ha2BrnUurP67YT4ZuWXyx2H2IqEImODKFgtzA8OqtrcJQ638OxPOHZMCGdmd/sVK
# 0Kc4ALLlFNWZP4oUlJQPITeSrRm08uI2Y/jVjF2U2sPSVsOQjxSYT7r+7RyUCjXX
# KM69gPf54mgR19hf3qmE5PfCdQXxOPwO7G6OnMNzWzGUtXM/CqtDZgzdQgD0aRf6
# aezcMD6nPGsPgD4k7k0eLMYum24mpH9bcQnAvGAxoG47fWzsxt7wbolm2jwB9DeN
# yGV7yeaeLEaL4Z0hq8e0hHDf+nUPkuNw/WtqX4Oo+mDSyqw1Kk35jtqcfO2VrGCq
# sBne362xQorD+ZQ+I3qvYDnFFDwc4u7FE6HR/vIjwdlANi7MnvSraq0a4Pchvl2b
# QaxixwqNhi6O9AfqB4HG/5k8Ao7jmERKSWHlru8P+g0xe8X346AybzOaF0pk7WQ9
# KqgHBtTI576Jy/h9olxXb6c65A97fZultM8OAHwiXBM7kK4L+tEiMu3LyXm7aN8p
# hrBUCZYH44UvqAWFaNuf+mJWQAzfFfF3SncvZJZxRotEHaVSTPiWMQZdO1/i9HSM
# JVa45kmRLURRDM83fTEfDRjNpFfTBBoo1UH6nF5D
