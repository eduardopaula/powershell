...
# Prompt for the DNS name of the Threat Detection server
$tdServer = Read-Host 'Enter the DNS name of the Threat Detection server'


# Prompt for the integration password for the Threat Detection server
$tdPassword = Read-host 'Enter the integration password for the Threat Detection server' -AsSecureString

# Prompt for administrator credential
Read-Host "Enter administrator account (domain\administrator) and password. Press any key to continue"
$credential = Get-Credential

[uint32] $historicalDays = Read-Host 'Specify days of historical events to build Threat Detection database? (0 for do not use historical events)'

New-CAThreatDetectionConfiguration -Connection $connection -TDServer $tdServer -TDPassword $tdPassword -AdminCredential $credential -HistoricalDays $historicalDays
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCB3HNycdhOMFkYE
# 2Qyoqu2gkQhBuo+NARriKoX9EsaKiKCCDB0wggXzMIIE26ADAgECAhAJvF2jX0kc
...
# DQEJBDEiBCDbX7XDenmgnWLwxAZIi0g6QoD4sZXDQddVOJTpj8iitzANBgkqhkiG
# 9w0BAQEFAASCAQBZ2h3ze5rvGX1D7iNJekHAIFOTPK+Vq8O98SuUF1TjhfO+jN0l
# 8NmrtHJNg46T7YBORRk5YLu6AsEQr3A/h4UDyVAeHOCif9mG5Wx6yl28eHXiSTCh
# l+0K5UB5cewHuRpqf+El97pguMdfSMBvoLDz8QBxkybjSjX96v5A9gq5D/5GLO+A
# w1tt0UbaN+2u807hi61NwgWQzQHNY2MTaUdWhbk3fMb1mScHdzV8s6/+T7EbFQaL
# ug9CEXbeGG0j/BrZOrMxI9njZAMq7/DD0FsAZCgydAsGpAwh2JWFv0MNSPaaLFRr
# qfL0PDFXt3M/P5cAzltwEi0elxxJu9xId/uyoYIXPzCCFzsGCisGAQQBgjcDAwEx
...
# BQAEIMnlADjA07vr5oZFKFqhZIxpW/EKE2O3uGWEGkjPrhHxAhBGJHkUVLHyLKVk
# 33SPZodUGA8yMDIzMTExMzE1MzQwMVqgghMJMIIGwjCCBKqgAwIBAgIQBUSv85Sd
...
# MsLCyQ+CXc6qisnGTxmcz0AwLwYJKoZIhvcNAQkEMSIEIIyspaVSHUzE9Vwbz0xH
# xpZLBePSjhSCSB7z+GSUXatrMDcGCyqGSIb3DQEJEAIvMSgwJjAkMCIEINL25G3t
# dCLM0dRAV2hBNm+CitpVmq4zFq9NGprUDHgoMA0GCSqGSIb3DQEBAQUABIICAJOV
# /fEQHoG1RtZUHZNZmRBn+NdOqb1VmpE7LfiFpexVI620GDPUw25a43s6slwOt/EG
# toGAOV3PCbCIceDNFkjBB8Mhh/fKSBtcAeMtrhWs0ydJEY844oEn9ZYiTG/PRs6v
# cHzVmd+j5gXQrENhkrgeVwMzZieA6Smn+/rRhE6z9DEO9fBXmMCIFX6jp4AcBj9h
# PIlPm+g1HUM5xjHQ0eMP9gsbmQFS1g2p104FZFJ0E1A746V0zVvWFd3yM6q19fOn
# lfAZdGpqcXhO1wTSMHma8aYlbkFJchR4kSQ67s7pjx+0fNMnP0iM4w6KcEqKLqXL
# 4JbpQW2IcNWeYuLdoSM5druWbOCgcX2XPV8xr2nekJWEPqzHjJBDNbpTgTry1hqZ
# QAozgX/4ptv74FcKactSuWG77zXNTalMp838t5q4Z9W661BApI/deHPALfmAw5Zm
# aH4NvpJ7lAANNQXSAs5M6l6R+O94gdSeO906UyjwdzJHdjEHe8AWM2dPT6bt+oXf
# 6L+ITGQNOloDVKiX1Txi/jt6isu/0pwzAZb9G+ajiEU+nNUCitbTBxLfiDFr8sgx
# l5jK9a4S7NXly4jDpcFueTbZQZQcvpBH4TBD5m0cEPuZYj8kyf6T+lLFOCN2HxWr
# 2pNUNkNUd2BCJ5xiKy2jKYtsREBGIxG9HL5L/gSf
